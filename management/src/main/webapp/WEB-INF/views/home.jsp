					...
					<div class="col-md-12">
						<div class="flexslider">
							<div class="flex-caption">
								<!-- Left column -->
								<div class="col-l">
									<p style="text-indent:2em;">EasyExam是一款基于SSM架构开发的在线考试系统。它可以稳定、顺畅的运行在Windows与Linux平台上。您可以通过它快捷方便的创建试题和题库，发布试卷，组织考试，系统自动批改。高度的可配置性和灵活性使得它可以被应用于很多领域。</p>
									<p style="text-indent:2em;">软件采用GPL协议，完全开放且免费，由www.bestick.cn提供技术支持。</p>
								</div>
								<!-- Right column -->
								<div class="col-r">
									...
									<p>如果您对本系统有任何反馈和建议，欢迎联系<a style="color: #fff !important;" href="mailto:admin@bestick.cn">admin@bestick.cn</a></p>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="copy">
							<p>
								EasyExam Copyright © <a href="http://www.bestick.cn/" target="_blank">EasyExam</a> - <a href="." target="_blank">主页</a> | <a href="http://www.bestick.cn/" target="_blank">关于我们</a> | <a href="http://www.bestick.cn/" target="_blank">FAQ</a> | <a href="http://www.bestick.cn/" target="_blank">联系我们</a>
							</p>
						</div>
					</div>
				</div>
